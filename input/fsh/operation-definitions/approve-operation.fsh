...
* parameter[=].min = 1
* parameter[=].max = "1"
* parameter[=].documentation = "The Bundle result containing all updated artifacts and the ArtifactAssessment (Basic in R4) resource containing the Approval metadata"
